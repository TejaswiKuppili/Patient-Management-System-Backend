...
namespace PatientManagementSystem.Data.Migrations
{
    ...
    [Migration("20250721101813_smallmigrations_related_profilesTable")]
    partial class smallmigrations_related_profilesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PatientManagementSystem.Data.Entities.Profile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PatientManagementSystem.Data.Entities.Patient", b =>
                {
                    b.HasOne("PatientManagementSystem.Data.Entities.ApplicationUser", "CreatedByEmployee")
            ...
            modelBuilder.Entity("PatientManagementSystem.Data.Entities.Profile", b =>
                {
                    b.HasOne("PatientManagementSystem.Data.Entities.ApplicationUser", "ApplicationUser")
                        .WithOne("Profile")
                        .HasForeignKey("PatientManagementSystem.Data.Entities.Profile", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
